...
/**
* @brief generate afficher  .
* @param SDL_Surface * screen char image
* @return Nothing
*/
...
* @param  SDL_Surface * screen,int s,int r,enigme *en
* @return nothing
*/ 
